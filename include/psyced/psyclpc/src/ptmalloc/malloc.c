...
* Version ptmalloc2-20011215
  $Id: malloc.c,v 1.1.1.1 2006/07/10 02:41:38 lynx Exp $
  based on:
...
#endif
{
  ...
  char*           _brk;            /* return value from MORECORE */
  ...
  */
  ...
  _brk = snd_brk = (char*)(MORECORE_FAILURE);
  ...
  */
  ...
  if (_brk != (char*)(MORECORE_FAILURE)) {
    ...
    */
    ...
    if (_brk == old_end && snd_brk == (char*)(MORECORE_FAILURE))
      set_head(old_top, (size + old_size) | PREV_INUSE);

    else if (contiguous(av) && old_size && _brk < old_end) {
    ...
    */
	...
	av->system_mem += _brk - old_end;
      ...
      if (contiguous(av)) {
        ...
        front_misalign = (INTERNAL_SIZE_T)chunk2mem(_brk) & MALLOC_ALIGN_MASK;
        if (front_misalign > 0) {
        ...
        */
        ...
        end_misalign = (INTERNAL_SIZE_T)(_brk + size + correction);
      ...
      /* handle non-contiguous cases */
        ...
        assert(((unsigned long)chunk2mem(_brk) & MALLOC_ALIGN_MASK) == 0);
  ...
  */
  ...
  if ((((unsigned long)(m)) % alignment) != 0) { /* misaligned */
    ...
    */
    ...
    _brk = (char*)mem2chunk(((unsigned long)(m + alignment - 1)) &
