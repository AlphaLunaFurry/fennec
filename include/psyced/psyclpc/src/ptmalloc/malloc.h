...
/*
  $Id: malloc.h,v 1.1.1.1 2006/07/10 02:41:38 lynx Exp $
...
extern __malloc_ptr_t malloc __MALLOC_P ((size_t __size, const char *__file, int __line)) __attribute_malloc__;
#else
